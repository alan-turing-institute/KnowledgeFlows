...
ggnet2(occ_SUF_net, node.size = 10, node.color = "steelblue", edge.size = 'SRt', edge.color = "lightgrey",size = "degree",label = TRUE,label.size = 3,size.cut = 6, label.color = 'black',mode = "fruchtermanreingold")
...
E(occ_SUF_net_noself)$width <- E(occ_SUF_net_noself)$SRt/3


plot(ceb,occ_SUF_net_noself,vertex.size=deg/10,labels=NA,  vertex.label.cex=.7)
