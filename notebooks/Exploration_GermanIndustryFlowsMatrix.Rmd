...
nace2_net_noself <- graph_from_data_frame(top_nace2_df[top_nace2_df$SRt!=1,],directed = FALSE)
#top_nace2_df[top_nace2_df$SRt!=1,]
...
ceb <- cluster_louvain(nace2_net_noself) 
...
unique(node_list[node_list$community==1,]$name)

subg1 <- induced.subgraph(nace2_net_noself, which(membership(ceb) == 1))

plot(subg1,  layout = layout,vertex.label.font=0.4, vertex.label.color="black",
     edge.color="grey", edge.curved=.1,vertex.label.cex=0.2)

```

```{r fig.width=6, fig.height=8, echo=FALSE}
subg2 <- induced.subgraph(nace2_net_noself, which(membership(ceb) == 2))

unique(node_list[node_list$community==2,]$name)


plot(subg2,  layout = layout,vertex.label.font=0.4, vertex.label.color="black",
     edge.color="grey", edge.curved=.1,vertex.label.cex=0.2)
```

```{r fig.width=6, fig.height=8, echo=FALSE}
subg3 <- induced.subgraph(nace2_net_noself, which(membership(ceb) == 3))

unique(node_list[node_list$community==3,]$name)


plot(subg3,  layout = layout,vertex.label.font=0.4, vertex.label.color="black",
     edge.color="grey", edge.curved=.1,vertex.label.cex=0.2)
```


```{r fig.width=6, fig.height=8, echo=FALSE}
subg4 <- induced.subgraph(nace2_net_noself, which(membership(ceb) == 4))

unique(node_list[node_list$community==4,]$name)


plot(subg4,  layout = layout,vertex.label.font=0.4, vertex.label.color="black",
     edge.color="grey", edge.curved=.1,vertex.label.cex=0.2)
```


```{r fig.width=6, fig.height=8, echo=FALSE}
subg5 <- induced.subgraph(nace2_net_noself, which(membership(ceb) == 5))

unique(node_list[node_list$community==5,]$name)

plot(subg5,  layout = layout,vertex.label.font=0.4, vertex.label.color="black",
     edge.color="grey", edge.curved=.1,vertex.label.cex=0.2)

```
```{r fig.width=6, fig.height=8, echo=FALSE}
subg6 <- induced.subgraph(nace2_net_noself, which(membership(ceb) == 6))

unique(node_list[node_list$community==6,]$name)


plot(subg6,  layout = layout,vertex.label.font=0.4, vertex.label.color="black",
     edge.color="grey", edge.curved=.1,vertex.label.cex=0.2)
```
