...
def draw_and_print_communities(network, net_community):
    ...
    figur_graph = igraph.plot(network, "../img/network_community.png", vertex_label=network.vs['subactivity'], edge_width=weights_,
                              vertex_size=20, vertex_label_size=12, layout=layout, bbox=(2200, 1200))
